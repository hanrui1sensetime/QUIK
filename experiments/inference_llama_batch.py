...
# load_qmodel_path = "/root/workspace/external_data/tigerbot-13b-base_v9_gpt4_hf/13bv9.1_quik_w4a4kv4.bin"
load_qmodel_path = "/root/workspace/external_data/tigerbot-13b-base_v9_gpt4_hf/13bv9.1_quik_w4a4kv4_16384.bin"
model_path = "/root/workspace/external_data/tigerbot-13b-base_v9_gpt4_hf"
# data_path = "/root/workspace/external_data/dayi_data"
data_path = "dayi_data"
predict_output_path = "/home/QUIK/predict_w4a4_speed_batch8"
seq_len = 16384
# seq_len = 2048  # for kvquant debug
w_bits = 4
a_bits = 4
kv_bits = 4
int8_down_proj = True
            ...
            for name in subset:
                ...
                if is_quantized:
                    ...
                    int_mod = qlinear.MixedQLinear.from_float(
                        ...
                        kvcache_bit=kv_bits)
                    if 'k_proj' in name or 'v_proj' in name:
                        int_mod.kvcache_meta = save_dict[
                            'model.layers.{}.{}.kvcache_meta'.format(i, name)]
                else:
                    int_mod = layer
...
for test_file_path in sorted(
    ...
    for data in tqdm(test_dataset):
        ...
        generation_config = GenerationConfig(
            max_length=seq_len,
            max_new_tokens=2048,  # for kvquant debug
            num_beams=1,
            do_sample=True,
            temperature=0.7,
            top_p=0.9,
