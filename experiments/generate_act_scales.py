...
def parse_args():
    ...
    parser.add_argument(
        ...
        help=
        'location of the calibration dataset, we use the validation set of the Pile dataset'
    )
...
def main():
    ...
    if not os.path.exists(args.dataset_path):
        ...
        print(
            'Please download the Pile dataset and put the validation set at the path'
        )
        print(
